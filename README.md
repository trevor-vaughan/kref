...
[![test](https://github.com/riotbox/kref/actions/workflows/test.yml/badge.svg)](https://github.com/riotbox/kref/actions/workflows/test.yml)
[![lint](https://github.com/riotbox/kref/actions/workflows/lint.yml/badge.svg)](https://github.com/riotbox/kref/actions/workflows/lint.yml)
[![security](https://github.com/riotbox/kref/actions/workflows/security.yml/badge.svg)](https://github.com/riotbox/kref/actions/workflows/security.yml)
[![megalint](https://github.com/riotbox/kref/actions/workflows/megalint.yml/badge.svg)](https://github.com/riotbox/kref/actions/workflows/megalint.yml)
[![Go](https://img.shields.io/github/go-mod/go-version/riotbox/kref)](go.mod)
...
```bash
go install github.com/riotbox/kref/cmd/kref@latest
```
...
```bash
gh attestation verify kref_<version>_linux_amd64.tar.gz --repo riotbox/kref
```
